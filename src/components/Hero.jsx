      ...
      <div className="relative z-10 flex flex-col lg:hidden pt-16">
        <div className="px-4 text-center z-50">
          ...
          <div className="flex flex-row items-center justify-center gap-3 md:gap-4 mt-8">
            <button className="bg-gradient-to-r from-teal-300 via-green-400 to-green-500 font-bold text-sm md:text-base py-2 px-5 md:py-3 md:px-6 rounded-full transition-transform hover:scale-105">
              Explore What We Do
            </button>
